    ...
    <div class="shadow border w-64 mr-10 z-30 h-[190px]">
        ...
        <div class="p-5 flex justify-between relative cursor-pointer border-b">
            ...
            <div v-if="modal.make" class="absolute border shadow left-56 p-5 top-1 -m-1 bg-white">
                <input type="text" class="border p-1 rounded" v-model="make" />
        ...
        <div class="p-5 flex justify-between relative cursor-pointer border-b">
            <h3>Price</h3>
            <h3 @click="updateModal('price')" class="text-blue-400 capitalize">1324</h3>
            <div v-if="modal.price" class="absolute border shadow left-56 p-5 top-1 -m-1 bg-white">
                <input type="text" class="border p-1 rounded" v-model="price" />
                <button class="bg-blue-400 w-full mt-2 rounded text-white p-1">
                    Apply
                </button>
            </div>
